      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_250px] gap-6">
          ...
          <div className="border-b border-slate-200 dark:border-slate-700 p-6">
            ...
            {file.aliases && file.aliases.length > 0 && (
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {file.aliases.map((alias) => (
                    <span
                      key={alias}
                      className="px-3 py-1 text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 rounded-full flex items-center gap-1"
                    >
